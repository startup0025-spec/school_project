...
Write-Host "Waiting 8 seconds for crash..."
Start-Sleep -Seconds 8

Write-Host "Dumping logcat to file..."
cmd.exe /c "C:\Users\user\AppData\Local\Android\Sdk\platform-tools\adb.exe logcat -d > C:\mobile\scripts\raw_crash_log.txt"
