...
Build-APK -Mode "DEMO" -OutName "Anyway_the_Sea_PATCHED_DEMO.apk"
Build-APK -Mode "PRODUCTION" -OutName "Anyway_the_Sea_PATCHED_PROD.apk"

Write-Host "Both builds completed successfully!"
