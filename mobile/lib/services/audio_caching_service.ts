...
export const BUNDLED_SOUNDS: Record<string, any> = {
  ...
  'sea_1.mp3': seaFallback,
  'sea_2.mp3': seaFallback,
  'sea_3.mp3': seaFallback,
  'sea_4.mp3': seaFallback,
  'sea_5.mp3': seaFallback,
  'river_1.mp3': riverFallback,
  'river_2.mp3': riverFallback,
  'river_3.mp3': riverFallback,
  'river_4.mp3': riverFallback,
  'river_5.mp3': riverFallback,
  'wind_1.mp3': windFallback,
  'wind_2.mp3': windFallback,
  'wind_3.mp3': windFallback,
  'wind_4.mp3': windFallback,
  'wind_5.mp3': windFallback,
};
