...
$apk = "C:\Users\user\Desktop\AnywayTheSea_Output\Anyway_the_Sea_UNIFIED.apk"
$outLog = "C:\Users\user\Desktop\school_contest\Anyway_the_Sea\mobile\crash_log.txt"

Write-Host "Killing existing adb server..."
& $adb kill-server
...
Write-Host "Waiting 15 seconds for crash..."
Start-Sleep -Seconds 15

Write-Host "Dumping logcat to file..."
cmd.exe /c "C:\Users\user\AppData\Local\Android\Sdk\platform-tools\adb.exe logcat -d > C:\Users\user\Desktop\school_contest\Anyway_the_Sea\mobile\crash_log.txt"
