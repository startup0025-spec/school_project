...
<body>
  ...
  <script>
    ...
    window.updateSpots = function(spots) {
      ...
      // Clear removed markers with prototype protection & memory leak prevention
...
// Haversine distance helper (meters) - coordinate safety checks included
...
export default function MapScreen() {
  ...
  // 4. Synchronize Spot Markers with WebView (Direct Object Script Injection)
  useEffect(() => {
